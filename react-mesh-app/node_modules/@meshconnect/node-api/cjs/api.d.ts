export interface ApiResult {
    readonly status?: 'ok' | 'serverFailure' | 'permissionDenied' | 'badRequest' | 'notFound' | 'conflict' | 'tooManyRequest' | 'locked';
...
export type ApiResultStatus = 'ok' | 'serverFailure' | 'permissionDenied' | 'badRequest' | 'notFound' | 'conflict' | 'tooManyRequest' | 'locked';
...
export interface B2BBrokerAuthRequest {
    ...
    mfaCode?: string | null;
    mfaType?: 'phone' | 'email' | 'totp' | 'phoneAndEmail' | 'requireNextSecurityQuestion' | 'readEmail' | 'face';
...
export interface B2BBrokerAuthResponse {
    ...
    status?: 'failed' | 'challengeFailed' | 'succeeded' | 'challengeIssued' | 'mfaRequired' | 'openInBrokerModule' | 'delayed' | 'deviceConfirmationRequired' | 'emailVerification' | 'emailReceived' | 'captchaChallenge' | 'faceVerification' | 'apiKeyLimitationExceeded' | 'bindMfaRequired';
...
export interface B2BBrokerCreateOrderResult {
    ...
    brokerType?: 'robinhood' | 'eTrade' | 'alpaca' | 'tdAmeritrade' | 'weBull' | 'stash' | 'interactiveBrokers' | 'public' | 'coinbase' | 'kraken' | 'coinbasePro' | 'cryptoCom' | 'openSea' | 'binanceUs' | 'gemini' | 'cryptocurrencyAddress' | 'cryptocurrencyWallet' | 'okCoin' | 'bittrex' | 'kuCoin' | 'etoro' | 'cexIo' | 'binanceInternational' | 'bitstamp' | 'gateIo' | 'acorns' | 'okx' | 'bitFlyer' | 'coinlist' | 'huobi' | 'bitfinex' | 'deFiWallet' | 'krakenDirect' | 'vanguard' | 'binanceInternationalDirect' | 'bitfinexDirect' | 'bybit' | 'paxos' | 'coinbasePrime' | 'btcTurkDirect' | 'kuCoinDirect' | 'okxOAuth';
    /** Side of the order. */
...
export interface B2BBrokerCryptocurrencyTransaction {
    ...
    blockchainMethod?: 'transfer' | 'swap' | 'mint' | 'withdraw' | 'claimRewards' | 'deposit' | 'approve' | 'forgeToken' | 'multicall' | 'migrateToken' | 'claim' | 'openSeaTransfer' | 'cancel' | 'commit' | 'run' | 'repay' | 'execute' | 'stake' | 'merge';
}
...
export interface B2BBrokerOrder {
    ...
    transactionType?: 'order' | 'conversionTo' | 'conversionFrom' | 'ownAccountDeposit' | 'ownAccountWithdraw' | 'stake' | 'dividendReinvestment' | 'interest' | 'reward' | 'unknown' | 'conversionToFiat' | 'conversionFromFiat';
...
export interface B2BBrokerOrderSymbolInfo {
    ...
    fractionalTradingAllowance?: 'fractionalTradingAllowed' | 'fractionalTradingNotAllowed' | 'tradingNotAllowed' | 'fractionalTradingPossiblyAllowed';
    /**
...
export interface B2BNftPosition {
    ...
    addressType?: 'ethAddress' | 'btcAddress' | 'ltcAddress' | 'solAddress' | 'algoAddress' | 'celoAddress' | 'cardanoAddress' | 'polygonAddress' | 'bnbAddress' | 'elrondAddress' | 'neoAddress' | 'xrpAddress' | 'flowAddress' | 'harmonyOneAddress' | 'tronAddress' | 'dogeAddress' | 'opAddress';
}
...
export type B2BTransactionType = 'order' | 'conversionTo' | 'conversionFrom' | 'ownAccountDeposit' | 'ownAccountWithdraw' | 'stake' | 'dividendReinvestment' | 'interest' | 'reward' | 'unknown' | 'conversionToFiat' | 'conversionFromFiat';
...
export type BrokerAuthStatus = 'failed' | 'challengeFailed' | 'succeeded' | 'challengeIssued' | 'mfaRequired' | 'openInBrokerModule' | 'delayed' | 'deviceConfirmationRequired' | 'emailVerification' | 'emailReceived' | 'captchaChallenge' | 'faceVerification' | 'apiKeyLimitationExceeded' | 'bindMfaRequired';
...
export type BrokerCryptocurrencyTransactionBlockchainMethod = 'transfer' | 'swap' | 'mint' | 'withdraw' | 'claimRewards' | 'deposit' | 'approve' | 'forgeToken' | 'multicall' | 'migrateToken' | 'claim' | 'openSeaTransfer' | 'cancel' | 'commit' | 'run' | 'repay' | 'execute' | 'stake' | 'merge';
...
export type BrokerCryptocurrencyTransactionStatus = 'unknown' | 'failed' | 'frozen' | 'succeeded' | 'mfaRequired' | 'pending' | 'expired' | 'canceled' | 'waitingForSignature' | 'waitingForClearing' | 'awaitingApproval' | 'awaitingConfirmation' | 'awaitingVerification' | 'rejected' | 'pendingCancel' | 'emailVerification' | 'deviceConfirmationRequired' | 'mfaFailed' | 'addressWhitelistRequired' | 'secondMfaRequired' | 'emailConfirmationApprovalRequired';
export type BrokerCryptocurrencyTransactionType = 'unknown' | 'deposit' | 'withdrawal';
export type BrokerFeature = 'holdings' | 'balance' | 'orders' | 'transfers' | 'identity' | 'cryptocurrencyDepositAddresses' | 'accountNumber' | 'paymentMethods' | 'conversions';
...
export type BrokerOptionDirection = 'unknown' | 'buyToOpen' | 'buyToClose' | 'sellToOpen' | 'sellToClose' | 'buyToCover' | 'sellShort';
export type BrokerOptionType = 'unknown' | 'call' | 'put';
export type BrokerOrderCategory = 'order' | 'trade' | 'ledger' | 'historyAction';
export type BrokerOrderPlaceType = 'unknown' | 'market' | 'limit' | 'stopLoss' | 'stopLimit' | 'takeProfit' | 'netDebit' | 'netCredit' | 'exercise';
export type BrokerOrderPlaceTypeTrade = 'market' | 'limit' | 'stopLoss';
export type BrokerOrderStatus = 'unknown' | 'inProgress' | 'cancelled' | 'rejected' | 'failed' | 'success' | 'partiallyFilled' | 'expired';
export type BrokerOrderTimeInForceType = 'goodTillCanceled' | 'immediateOrCancel' | 'fillOrKill' | 'goodForDay' | 'postOnly' | 'unknown';
...
export interface ConfigureTransferRequest {
    ...
    fromType: 'robinhood' | 'eTrade' | 'alpaca' | 'tdAmeritrade' | 'weBull' | 'stash' | 'interactiveBrokers' | 'public' | 'coinbase' | 'kraken' | 'coinbasePro' | 'cryptoCom' | 'openSea' | 'binanceUs' | 'gemini' | 'cryptocurrencyAddress' | 'cryptocurrencyWallet' | 'okCoin' | 'bittrex' | 'kuCoin' | 'etoro' | 'cexIo' | 'binanceInternational' | 'bitstamp' | 'gateIo' | 'acorns' | 'okx' | 'bitFlyer' | 'coinlist' | 'huobi' | 'bitfinex' | 'deFiWallet' | 'krakenDirect' | 'vanguard' | 'binanceInternationalDirect' | 'bitfinexDirect' | 'bybit' | 'paxos' | 'coinbasePrime' | 'btcTurkDirect' | 'kuCoinDirect' | 'okxOAuth';
    /**
...
export interface ConfigureTransferResponse {
    /** Status of the operation. */
    status?: 'succeeded' | 'failed' | 'validationFailed' | 'notAuthorizedTo' | 'notAuthorizedFrom' | 'kycRequired' | 'fromIntegrationNotSupported' | 'toIntegrationNotSupported';
...
export type ConfigureTransferStatus = 'succeeded' | 'failed' | 'validationFailed' | 'notAuthorizedTo' | 'notAuthorizedFrom' | 'kycRequired' | 'fromIntegrationNotSupported' | 'toIntegrationNotSupported';
export interface CountryInfo {
    countryCode?: string | null;
    countryNumber?: string | null;
    description?: string | null;
}
export type CryptocurrencyAddressType = 'ethAddress' | 'btcAddress' | 'ltcAddress' | 'solAddress' | 'algoAddress' | 'celoAddress' | 'cardanoAddress' | 'polygonAddress' | 'bnbAddress' | 'elrondAddress' | 'neoAddress' | 'xrpAddress' | 'flowAddress' | 'harmonyOneAddress' | 'tronAddress' | 'dogeAddress' | 'opAddress';
export type CryptocurrencyFundingOptionType = 'existingCryptocurrencyBalance' | 'buyingPowerPurchase' | 'paymentMethodDepositUsage' | 'cryptocurrencyConversion' | 'stableCoinNoFeeConversion' | 'cryptocurrencyBuyingPowerConversion';
export interface DeFiWalletHealthStatusInfo {
    /** @format uuid */
    id?: string;
    name?: string | null;
}
export type ExecuteTransferMfaType = 'unspecified' | 'phone' | 'email' | 'totp' | 'face';
...
export interface ExecuteTransferResponse {
    ...
    status?: 'succeeded' | 'failed' | 'mfaRequired' | 'emailConfirmationRequired' | 'deviceConfirmationRequired' | 'mfaFailed' | 'addressWhitelistRequired' | 'secondMfaRequired' | 'deFiWalletConfirmationRequired' | 'emailConfirmationApprovalRequired';
...
export type ExecuteTransferStatus = 'succeeded' | 'failed' | 'mfaRequired' | 'emailConfirmationRequired' | 'deviceConfirmationRequired' | 'mfaFailed' | 'addressWhitelistRequired' | 'secondMfaRequired' | 'deFiWalletConfirmationRequired' | 'emailConfirmationApprovalRequired';
export type FailureReason = 'notSupportedOnIntegration' | 'notSupportedOnNetwork' | 'invalidAddressFormat' | 'notSupportedOnToken';
export type FinancialInstitutionIntegrationType = 'brokerage' | 'bank' | 'exchange' | 'wallet' | 'address' | 'nftMarketplace' | 'deFiWallet';
...
export type HoldingTransferIneligibilityReason = 'noEligibleNetworks' | 'symbolDoesNotMatch' | 'notSupportedForTransferByTarget' | 'notSupportedForTransferBySource' | 'eligibleWithFunding' | 'amountNotSufficient';
...
export type MfaType = 'phone' | 'email' | 'totp' | 'phoneAndEmail' | 'requireNextSecurityQuestion' | 'readEmail' | 'face';
...
export type NetworkTransferIneligibilityReason = 'amountNotSufficient' | 'gasFeeAssetBalanceNotEnough' | 'noTargetNetworkFound' | 'refusedByInstitution' | 'eligibleWithFunding' | 'balanceBelowRequestedAmount' | 'requestedAmountBelowMinimum' | 'balanceBelowMinimum' | 'requestedAmountBelowFees' | 'requestedAmountBelowClientMinimum' | 'requestedAmountAboveClientMaximum';
...
export interface QuoteFundingOption {
    ...
    fundingOption?: 'existingCryptocurrencyBalance' | 'buyingPowerPurchase' | 'paymentMethodDepositUsage' | 'cryptocurrencyConversion' | 'stableCoinNoFeeConversion' | 'cryptocurrencyBuyingPowerConversion';
...
export type SymbolTradingAllowance = 'fractionalTradingAllowed' | 'fractionalTradingNotAllowed' | 'tradingNotAllowed' | 'fractionalTradingPossiblyAllowed';
...
export type TransferBalanceFundingAvailabilityStatus = 'disabled' | 'available' | 'requiresAmountLowering' | 'notApplicable' | 'unavailable';
...
export interface TransferFundingModel {
    ...
    type?: 'existingCryptocurrencyBalance' | 'buyingPowerPurchase' | 'paymentMethodDepositUsage' | 'cryptocurrencyConversion' | 'stableCoinNoFeeConversion' | 'cryptocurrencyBuyingPowerConversion';
    /**
     * Amount funded.
     * @format double
     */
...
export type TransferOrderByFields = 'id' | 'clientTransferId' | 'userId' | 'fromType' | 'amountInFiat' | 'status' | 'createdTimestamp' | 'symbol' | 'networkName';
 ...
 */
export declare class FrontApi<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    assets: {
        /**
         * No description
         *
         ...
         */
        v1AssetsDetail: (assetType: 'equity' | 'cryptocurrency', query?: {
            Search?: string;
            /** @format int32 */
            Count?: number;
            /** @format int32 */
            Offset?: number;
        }, params?: RequestParams) => Promise<AxiosResponse<AssetPaginationResponseApiResult, any>>;
        /**
         * No description
         *
         * @tags Assets
         ...
         * @response `401` `any` Unauthorized
         */
        v1AssetsEquityPriceDetail: (symbol: string, params?: RequestParams) => Promise<AxiosResponse<B2BPriceInfoApiResult, any>>;
    };
    balance: {
        /**
         ...
         */
        v1BalanceGetCreate: (data: BalanceBrokerBaseRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerAccountBalanceModelApiResult, any>>;
        /**
         ...
         * @response `403` `any` The API key used does not have read permission to call this Mesh endpoint.
         */
        v1BalancePortfolioList: (query?: {
            /** End user ID to get the aggregated portfolio for. */
            UserId?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<B2BFiatPortfolioModelApiResult, any>>;
    };
    brokerAccountDetail: {
        /**
         ...
         */
        v1AccountVerifyCreate: (data: B2BBrokerAccountDetailsRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerAccountDetailsResponseApiResult, any>>;
    };
    managedAccountAuthentication: {
        ...
        v1CataloglinkList: (query: {
             ...
             */
            DisableApiKeyGeneration?: boolean;
        }, params?: RequestParams) => Promise<AxiosResponse<CatalogLinkApiResult, any>>;
        /**
        ...
        v1CataloglinkCreate: (query: {
             ...
             */
            DisableApiKeyGeneration?: boolean;
        }, data: InitializeTransfersForLinkRequest, params?: RequestParams) => Promise<AxiosResponse<CatalogLinkApiResult, any>>;
        /**
         ...
         * @response `404` `ApiResult` API Client not found.
         */
        v1LinktokenCreate: (data: GetLinkTokenRequest, params?: RequestParams) => Promise<AxiosResponse<LinkTokenModelApiResult, any>>;
        /**
         * @description Refresh auth token of the connected institution. Some institutions do not require tokens to be refreshed. The following institutions require custom flows: WeBull: AuthToken should be provided along with the RefreshToken Vanguard: security settings may activate MFA, requiring user action. If MFA is triggered, a second refresh request should be sent. Second request should contain MFA code and access token obtained from initial response. Bitfinex Direct: Expired Access Token is used as Refresh token. Use this endpoint to trade it for a new one
         *
         * @tags Managed Account Authentication
         ...
         * @response `401` `any` Unauthorized
         */
        v1TokenRefreshCreate: (data: BrokerRefreshTokenRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerRefreshTokenResponseApiResult, any>>;
        /**
         ...
         * @response `401` `any` Unauthorized
         */
        v1AccountDelete: (data: BrokerBaseRequest, params?: RequestParams) => Promise<AxiosResponse<ApiResult, any>>;
        /**
         ...
         * @response `401` `any` Unauthorized
         */
        v1StatusList: (params?: RequestParams) => Promise<AxiosResponse<B2BBrokersHealthStatusListApiResult, any>>;
        /**
         ...
         */
        v1IntegrationsList: (params?: RequestParams) => Promise<AxiosResponse<IntegrationsResponseApiResult, any>>;
    };
    selfManagedAccountAuthentication: {
         ...
         * @response `401` `any` Unauthorized
         */
        v1AuthenticationSchemesList: (params?: RequestParams) => Promise<AxiosResponse<BrokerAuthenticationSchemeIReadOnlyCollectionApiResult, any>>;
        /**
         ...
         */
        v1AuthenticateCreate: (query: {
            /** Id of the end-user */
            userId: string;
        }, data: B2BBrokerAuthRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerAuthResponseApiResult, any>>;
        /**
         ...
         * @response `400` `ProblemDetails` Bad Request
         */
        v1AuthenticateDetail: (brokerType: 'robinhood' | 'eTrade' | 'alpaca' | 'tdAmeritrade' | 'weBull' | 'stash' | 'interactiveBrokers' | 'public' | 'coinbase' | 'kraken' | 'coinbasePro' | 'cryptoCom' | 'openSea' | 'binanceUs' | 'gemini' | 'cryptocurrencyAddress' | 'cryptocurrencyWallet' | 'okCoin' | 'bittrex' | 'kuCoin' | 'etoro' | 'cexIo' | 'binanceInternational' | 'bitstamp' | 'gateIo' | 'acorns' | 'okx' | 'bitFlyer' | 'coinlist' | 'huobi' | 'bitfinex' | 'deFiWallet' | 'krakenDirect' | 'vanguard' | 'binanceInternationalDirect' | 'bitfinexDirect' | 'bybit' | 'paxos' | 'coinbasePrime' | 'btcTurkDirect' | 'kuCoinDirect' | 'okxOAuth', query: {
            /** Id of the end-user */
            userId: string;
        }, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerAuthPromptResponseApiResult, any>>;
    };
    managedTransfers: {
        /**
         ...
         * @response `401` `any` Unauthorized
         */
        v1TransfersManagedNetworksList: (params?: RequestParams) => Promise<AxiosResponse<NetworkModelResponseApiResult, any>>;
        /**
         ...
         * @response `401` `any` Unauthorized
         */
        v1TransfersManagedIntegrationsList: (params?: RequestParams) => Promise<AxiosResponse<IntegrationNetworkResponseApiResult, any>>;
        /**
         ...
         */
        v1TransfersManagedTokensList: (params?: RequestParams) => Promise<AxiosResponse<TokenNetworksResponseApiResult, any>>;
        /**
         ...
         * @response `401` `any` Unauthorized
         */
        v1TransfersManagedVerifyList: (data: TransferVerificationRequest, params?: RequestParams) => Promise<AxiosResponse<TransferVerificationResponseApiResult, any>>;
        /**
         ...
         */
        v1TransfersManagedConfigureCreate: (data: ConfigureTransferRequest, params?: RequestParams) => Promise<AxiosResponse<ConfigureTransferResponseApiResult, any>>;
        /**
         ...
         * @response `403` `any` The API key used does not have write permission to call this Mesh endpoint.
         */
        v1TransfersManagedPreviewCreate: (data: PreviewTransferRequest, params?: RequestParams) => Promise<AxiosResponse<PreviewTransferResponseApiResult, any>>;
        /**
         ...
         * @response `403` `any` The API key used does not have write permission to call this Mesh endpoint.
         */
        v1TransfersManagedExecuteCreate: (data: ExecuteTransferRequest, params?: RequestParams) => Promise<AxiosResponse<ExecuteTransferResponseApiResult, any>>;
        /**
         ...
         */
        v1TransfersManagedAddressGetCreate: (data: ManagedBrokerCryptocurrencyDepositAddressRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerCryptocurrencyDepositAddressResponseApiResult, any>>;
        /**
         ...
         * @response `401` `any` Unauthorized: Client Id or Client Secret are not correct or missing.
         */
        v1TransfersManagedQuoteCreate: (data: QuoteTransferRequest, params?: RequestParams) => Promise<AxiosResponse<QuoteTransferResponseApiResult, any>>;
        /**
         ...
         * @response `401` `any` Unauthorized: Client Id or Client Secret are not correct or missing.
         */
        v1TransfersManagedMeshList: (query?: {
            /**
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<TransferModelPaginationResponseApiResult, any>>;
        /**
         ...
         * @response `403` `any` The API key used does not have write permission to call this Mesh endpoint.
         */
        v1TransfersManagedUpdateCreate: (data: UpdateTransferStatusRequest, params?: RequestParams) => Promise<AxiosResponse<UpdateTransferResponseApiResult, any>>;
    };
    portfolio: {
        /**
         ...
         * @response `403` `any` The API key used does not have read permission to call this Mesh endpoint.
         */
        v1HoldingsGetCreate: (data: PortfolioHoldingsRequest, params?: RequestParams) => Promise<AxiosResponse<HoldingsModelApiResult, any>>;
        /**
         ...
         * @response `403` `any` The API key used does not have read permission to call this Mesh endpoint.
         */
        v1HoldingsValueCreate: (data: PortfolioBrokerBaseRequest, params?: RequestParams) => Promise<AxiosResponse<BrokerPortfolioValueModelApiResult, any>>;
        /**
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<B2BPortfolioModelApiResult, any>>;
    };
    transactions: {
        /**
         ...
         * @response `403` `any` The API key used does not have read permission to call this Mesh endpoint.
         */
        v1TransactionsListCreate: (data: TransactionsB2BBrokerOrderListRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerOrderListResponseApiResult, any>>;
        /**
         ...
         */
        v1TransactionsDetailsCreate: (data: TransactionsB2BBrokerOrderRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerOrderApiResult, any>>;
        /**
         ...
         * @response `401` `any` Unauthorized: Client Id or Client Secret are not correct or provided integration token is not correct.
         */
        v1TransactionsFeatureListCreate: (data: TransactionsBrokerBaseRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerTradingFeatureInfoApiResult, any>>;
        /**
         ...
         * @response `403` `any` The API key used does not have write permission to call this Mesh endpoint.
         */
        v1TransactionsPreviewCreate: (side: 'unknown' | 'buy' | 'sell', data: TransactionsB2BBrokerCreateOrderRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerPreviewOrderResultApiResult, any>>;
        /**
         ...
         * @response `403` `any` The API key used does not have write permission to call this Mesh endpoint.
         */
        v1TransactionsCreate: (side: 'unknown' | 'buy' | 'sell', data: TransactionsB2BBrokerCreateOrderRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerCreateOrderResultApiResult, any>>;
        /**
         ...
         */
        v1TransactionsCancelCreate: (data: TransactionsB2BBrokerOrderRequest, params?: RequestParams) => Promise<AxiosResponse<ApiResult, any>>;
        /**
         ...
         */
        v1TransactionsSymbolinfoCreate: (data: TransactionsB2BBrokerSymbolInfoForOrderRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerOrderSymbolInfoApiResult, any>>;
    };
    transfers: {
        /**
         ...
         * @response `403` `any` The API key used does not have read permission to call this Mesh endpoint.
         */
        v1TransfersListCreate: (data: TransfersBrokerTransactionsListRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerTransactionsListModelApiResult, any>>;
        /**
         ...
         */
        v1TransfersDetailsCreate: (data: TransfersBrokerCryptocurrencyTransactionDetailsRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerCryptocurrencyTransactionApiResult, any>>;
        /**
         ...
         * @response `403` `any` The API key used does not have write permission to call this Mesh endpoint.
         */
        v1TransfersCreate: (data: TransfersBrokerCreateCryptocurrencyTransactionRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerCreateCryptocurrencyTransactionResponseApiResult, any>>;
        /**
         * @description Get or generate a cryptocurrency deposit address that can be used to transfer assets to the financial institution
         *
         * @tags Transfers
         ...
         * @response `404` `ApiResult` Address for the required symbol is not found.
         */
        v1TransfersAddressGetCreate: (data: TransfersBrokerCryptocurrencyDepositAddressRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerCryptocurrencyDepositAddressResponseApiResult, any>>;
        /**
         ...
         */
        v1TransfersSymbolDetailsCreate: (data: TransfersBrokerCryptocurrencyDepositAddressRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerCryptocurrencySymbolDetailsResponseApiResult, any>>;
    };
}
